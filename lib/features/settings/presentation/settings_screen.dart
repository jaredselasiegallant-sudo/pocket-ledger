...
class SettingsScreen extends ConsumerWidget {
  ...
  Future<void> _exportExcel(BuildContext context, WidgetRef ref) async {
    ...
    try {
      ...
      final transactions = await txnRepo.getAll(limit: 1000);
      final txnData = transactions
          .map((t) => {
                'title': t.title,
                'amount': t.amount,
                'type': t.type,
      ...
      await ExportEngine.exportToExcel(transactions: txnData);
  ...
  Future<void> _exportPdf(BuildContext context, WidgetRef ref) async {
    ...
    try {
      ...
      await ExportEngine.exportToPdf(transactions: txnData);
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
          ...
          'with Ghana Cedi (GHS) as default currency. '
